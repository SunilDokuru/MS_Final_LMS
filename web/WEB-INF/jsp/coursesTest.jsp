            ...
            <div class="col-md-10">
                <section id="my-courses">
                    <ul class="nav nav-tabs" id="tabs">
                        ...
                        <li class="active"><a href="#tab-my-courses">My Courses</a></li>
                                ...
                                <table id="courses">
                                    ...
                                    <tbody>
                                        <c:forEach var="map" items="${courses}">                                            
                                            <tr>
                                                <td class="course-category"><a href="${pageContext.request.contextPath}/courses/${map.get('courseID')}.htm">${map.get("courseName")}</a></td>
                                                <td><a href="${pageContext.request.contextPath}/courses/${map.get('courseID')}.htm">${map.get("MeetingDays")}</a></td>
                                                <td><a href="${pageContext.request.contextPath}/courses/${map.get('courseID')}.htm">${map.get("StartDate")}</a></td>
                                                <td class="status"><a href="${pageContext.request.contextPath}/courses/${map.get('courseID')}.htm">${map.get("Status")}</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
